...
//    ///
//    if ([xpath isEqualToString:@"//default:ncx/default:navMap"]) {
//        xmlXPathObjectPtr testResult = xmlXPathEvalExpression([xpath xmlChar], xpathCtx);
//        
//        if (testResult == 0) {
//            NSLog(@"testResult is 0");
//        }
//        else if (xmlXPathNodeSetIsEmpty(testResult->nodesetval)) {
//            NSLog(@"empty");
//        }
//    }
//    
//    ///
	...
	while(rootNode != NULL)
	{
//        DDXMLElement *root = [DDXMLElement nodeWithElementPrimitive:rootNode owner:self];
//        NSLog(@"doc->children:\n%@",root);
